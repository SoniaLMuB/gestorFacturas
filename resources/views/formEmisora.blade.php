      ...
      <!-- Login form -->
        <div class="flex flex-wrap content-center justify-center rounded-l-md bg-white" style="width: 24rem; height: 32rem;">
            ...
            <form action="{{route('emisora.store')}}" method="POST" novalidate>
                    ...
                    <div  class="mb-5">
                        <!--Usuario-->
                        <label for="razon_social" class="mb-2 block uppercase text-gray-500 font-bold">Razón Social</label>
                        <input id="razon_social" name="razon_social" type="text" placeholder="tu Razón Social" class="border p-3 w-full rounded-lg
                    ...
                    <div  class="mb-5">
                        <!--Usuario-->
                        <label for="rfc_emisora" class="mb-2 block uppercase text-gray-500 font-bold">RFC</label>
